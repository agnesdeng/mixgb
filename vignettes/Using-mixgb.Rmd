...
imputed.data <- mixgb(
  ...
  ordinalAsInteger = FALSE, bootstrap = TRUE,
...
Since using `mixgb_cv()` with this dataset mostly returns a number around `20`, I'll set `nrounds = 20` in `mixgb()` to obtain `m` imputed
datasets.
