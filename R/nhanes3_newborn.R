...
#'  \item{BMPHEAD}{Head circumference (cm)}
#'  \item{BMPRECUM}{Recumbent length (cm)}
#'  \item{BMPSB1}{First subscapular skinfold (mm)}
#'  \item{BMPSB2}{Second subscapular skinfold (mm)}
#'  \item{BMPTR1}{First triceps skinfold (mm)}
#'  \item{BMPTR2}{Second triceps skinfold (mm)}
#'  \item{BMPWT}{Weight (kg)}
#'  \item{DMPPIR}{Poverty income ratio}
#'  \item{HFF1}{Does anyone who lives here smoke cigarettes in the home? A factor variable with levels 1 (Yes) and 2 (No).}
#'  \item{HYD1}{How is health of SP in general? An ordinal factor with levels 1 (Excellent), 2 (Very good), 3 (Good), 4 (Fair) and 5 (Poor).}
#' }
