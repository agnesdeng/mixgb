...
# mixgb <a href="https://agnesdeng.github.io/mixgb/"><img src="man/figures/logo.png" align="right" height="138" alt="mixgb website" /></a>
...
The function `check_data()` performs a preliminary check and attempts to
...
check_data(data = bad_data, max_levels = 10)
```
...
imputed data. The package supports imputed data generated by various
multiple imputation methods, including `mixgb`, `mice`, and more.
