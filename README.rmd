...
You can install the current development version of mixgb from [GitHub](https://github.com/) with:
...
Simulations and computational time experiments in our paper [Preprint](https://arxiv.org/abs/2106.01574) use mixgb version 0.1.1. It can be installed with: 
``` r
# install.packages("devtools")
