...
The R package **mixgb** provides a scalable approach for multiple imputation by leveraging XGBoost, subsampling and predictive mean matching. We have shown that our method can yield less biased estimates and reflect appropriate imputation variability, while achieving high computational efficiency. For further details, see our paper  [Multiple Imputation Through XGBoost][mixgb-url].
...
* Support saving intermediate imputation summary statistics so that they can be passed to the [vismi][vismi-url] package for convergence diagnostics.
...
[vismi-url]: https://github.com/agnesdeng/vismi
