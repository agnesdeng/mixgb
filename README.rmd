...
```{r}
cv.results <- mixgb_cv(data = nhanes3_newborn, nfold = 10, nrounds = 100, early_stopping_rounds = 1, response = "BMPHEAD", select_covariates = c("HSHSIZER", "HSAGEIR", "HSSEX", "DMARETHN", "BMPRECUM", "BMPSB1", "BMPSB2", "BMPTR1", "BMPTR2", "BMPWT", "DMPPIR", "HFF1", "HYD1"), verbose = FALSE)
...
Here are some examples. For more details, please check the vignettes [Visual diagnostics for multiply imputed values][Visual-diagnostics].
```{r}
