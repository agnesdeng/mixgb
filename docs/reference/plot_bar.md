...
Plot bar plots of observed values versus m sets of imputed values for a
specified factor variable using ggplot2.
...
#> ℹ The deprecated feature was likely used in the mixgb package.
#>   Please report the issue at <https://github.com/agnesdeng/mixgb/issues>.
```
